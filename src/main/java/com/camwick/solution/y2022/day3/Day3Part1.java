...
public class Day3Part1 extends ProblemSolution {
    ...
    public Day3Part1(boolean test, String fileName, String currentDay)
            throws ClientProtocolException, IOException {
        super("2022", "3", "1", test, fileName, currentDay);
    }
    ...
    public void solve() {
        ...
        for (String rucksack : rucksacks) {
            String[] parts = { rucksack.substring(0, rucksack.length() / 2),
